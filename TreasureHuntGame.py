...
def display_game_intro():
    print('''
            ...
            After a long journey, you find yourself in front
            of two caves. One cave leads to a treasure, the
            other, a spike filled pit of death. Being brave,
            and a little greedy for treasure, you've decided
            to go for it!
